package jp.coremind.module
{
    ...
    public class StatusModule extends Dispatcher implements IModule
    {
        ...
        {
            Log.custom(TAG, "StatusModel destroy");
        ...
        public function update(...params):void
        {
            ...
            Log.custom(TAG, "us", statusGroup, statusValue, isInitialize, "call dispatch?", isInitialize || !equalGroup(beforeGroup) || !equal(beforeStatus));
