package jp.coremind.module
{
    ...
    public class DragModule extends Dispatcher implements IModule
    {
        //再利用インスタンス
        ...
        protected var _dragControl:Drag;
        ...
        public function DragModule(container:IContainer)
        {
            _container    = container;
            _before       = new Before();
            _dragArea     = new Rectangle();
            _dragSize     = new Point();
            _initializeDragControl();
        }
        
        protected function _initializeDragControl():void
        {
            _dragControl  = new Drag();
        }
